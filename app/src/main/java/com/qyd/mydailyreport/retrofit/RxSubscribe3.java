...
/**
 * Created by Ian on 2019/7/3.
 */
public class RxSubscribe3<T> implements ObservableSource<T>,Observer<T> {
    ...
    public RxSubscribe3(Context context) {
        this(context, "加载中...");
    }

    public RxSubscribe3(Context context, String msg) {
        this(context, msg,true);
    }

    public RxSubscribe3(Context context, String msg, boolean isShowProgress) {
        mContext = context;
        this.msg = msg;
